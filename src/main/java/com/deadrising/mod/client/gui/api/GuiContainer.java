...
import com.deadrising.mod.client.gui.GuiDead;
...
public class GuiContainer {
    ...
    public int posY;
    public int width;
    public GuiDead parentGUI;
    public int height;
    protected String color = "0x000000";

    public GuiContainer(int containerID, int posX, int posY, int width, int height, GuiDead parentGUI) {
