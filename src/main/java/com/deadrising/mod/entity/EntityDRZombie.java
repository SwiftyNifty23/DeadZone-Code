...
public class EntityDRZombie extends EntityZombie
{
	
	private static final DataParameter<Integer> VARIANT = EntityDataManager.<Integer>createKey(EntityDRZombie.class, DataSerializers.VARINT);
	...
	public EntityDRZombie(World worldIn) {
		super(worldIn);
