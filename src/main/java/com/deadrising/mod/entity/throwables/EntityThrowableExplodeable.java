...
public abstract class EntityThrowableExplodeable extends Entity implements IEntityAdditionalSpawnData {
    ...
    public void onUpdate() {
        ...
        if(!world.isRemote) {
            Vec3d from = DeadrizingUtil.getPositionVec(this);
            Vec3d to = DeadrizingUtil.getMotionVec(this);
    ...
    private void onCollide(Vec3d from, Vec3d to, RayTraceResult rayTraceResult) {
