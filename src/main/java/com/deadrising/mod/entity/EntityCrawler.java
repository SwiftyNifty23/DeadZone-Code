...
public class EntityCrawler extends EntityZombie
{
	...
	private static final DataParameter<Integer> VARIANT = EntityDataManager.<Integer>createKey(EntityCrawler.class, DataSerializers.VARINT);
    ...
    {
        return MathHelper.clamp(((Integer)this.dataManager.get(VARIANT)).intValue(), 0, 2);
    }
