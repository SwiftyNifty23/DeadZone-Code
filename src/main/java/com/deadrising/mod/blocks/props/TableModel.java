...
public class TableModel extends Block implements IHasModel {
	
    public static final PropertyDirection FACING = PropertyDirection.create("facing");
    
    public static final AxisAlignedBB AABBs = new AxisAlignedBB(-.1, 0, -.1, 1, .8, 2);

	public TableModel(String name, Material material, CreativeTabs tab)
	{
		super(material);
