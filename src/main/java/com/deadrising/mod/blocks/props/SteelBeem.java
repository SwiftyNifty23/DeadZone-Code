...
public class SteelBeem extends Block implements IHasModel 
{
    ...
    public static final AxisAlignedBB AABBs = new AxisAlignedBB(0, 0, -1.1, 1, .6, 2);
	...
	public SteelBeem(String name, Material material, CreativeTabs tab)
	{
		super(material);
