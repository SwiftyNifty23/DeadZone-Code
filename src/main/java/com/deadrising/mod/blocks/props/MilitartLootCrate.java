...
public class MilitartLootCrate extends Block implements IHasModel {
	
    public static final PropertyDirection FACING = PropertyDirection.create("facing");
    
    public static final AxisAlignedBB AABBs = new AxisAlignedBB(-.1, 0, 1, 2, 1.3, 0);

	public MilitartLootCrate(String name, Material material, CreativeTabs tab)
	{
		super(material);
